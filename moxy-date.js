...
var MoxyDate = /** @class */ (function () {
    ...
    MoxyDate.prototype.toString = function () {
        ...
        if (this._format) {
            ...
            if (this._format === 'YYYY-MM-DD' || lowerFormat === 'yyyy-mm-dd') {
                ...
                this._formatted = MONTH_TRANSLATION[month].full + " " + date + this._getSuffix(date) + ", " + year + " " + h + ":" + minutes + ampm;
                return this._formatted;
            }
                ...
                this._format = 'YYYY-MM-DD hh:mm:ss';
                this._formatted = year + "-" + MONTH_TRANSLATION[month].number + "-" + date + " " + hours + ":" + minutes + ":" + seconds + "." + this._date
                    .valueOf()
                    .toString()
                    .slice(-3);
                return this._formatted;
                ...
                this._formatted = year + "-" + MONTH_TRANSLATION[month].number + "-" + date + "T" + hours + ":" + minutes + ":" + seconds + "." + this._date
                    .valueOf()
                    .toString()
                    .slice(-3) + "Z";
                return this._formatted;
